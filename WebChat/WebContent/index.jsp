			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						<form name="loginform" action="/WebChat/login" method="post"
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="user" class="input-tips2">用户名：</label>
							<div class="inputOuter2">
								<input type="text" id="user" name="rname" maxlength="16"
									class="inputstyle2" />
							</div></li>

						<li><label for="passwd" class="input-tips2">密码：</label>
							<div class="inputOuter2">
								<input type="password" id="passwd" name="rpassword"
